...
class InstagramVerification:
    def __init__(self, technolightyt):
        self.username = technolightyt
        self.is_verified = False
        self.verification_attempts = 0
    
    def apply_for_verification(self):
        print(f"Initiating verification process for {self.technolightyt}...")
        time.sleep(2)
...
my_instagram = InstagramVerification("technolightyt")
